...
const CAP_META: Record<ModelCapability, { icon: React.ElementType, label: string, color: string }> = {
    ...
    voice: { icon: Mic, label: 'Voice', color: 'text-emerald border-emerald-800/30 bg-emerald-950/20' },
    video: { icon: Video, label: 'Video', color: 'text-purple-400 border-purple-800/30 bg-purple-950/20' },
    tools: { icon: Wrench, label: 'Tools', color: 'text-amber border-amber-800/30 bg-amber-950/20' },
    reasoning: { icon: BrainCircuit, label: 'Reasoning', color: 'text-indigo border-indigo-800/30 bg-indigo-950/20' },
}
