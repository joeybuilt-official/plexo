...
export const agentImprovementLog = pgTable('agent_improvement_log', {
    ...
    workspaceId: uuid('workspace_id')
        .notNull()
        .references(() => workspaces.id, { onDelete: 'cascade' }),
    patternType: text('pattern_type').notNull(), // failure_pattern | success_pattern | tool_preference | scope_adjustment | skill_proposal | extension_proposal | agent_proposal (legacy: plugin_proposal)
    description: text('description').notNull(),
