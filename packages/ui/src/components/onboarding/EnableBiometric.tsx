...
export function EnableBiometric({ onComplete }: { onComplete: () => void }) {
    ...
    if (!checked) return <div className="flex h-full items-center justify-center"><p className="text-text-muted">Checking device...</p></div>

    return (
        <div className="flex flex-col p-6 space-y-6 max-w-md mx-auto h-full justify-center text-center">
            <h1 className="text-2xl font-bold text-text-primary">Unlock faster</h1>
            <p className="text-text-secondary">Use your fingerprint to open Plexo securely.</p>
