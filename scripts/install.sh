...
echo ""
echo -e "  ${YELLOW}NOTE: If you have run this before, an existing 'pgdata' volume may keep its old password.${RESET}"
echo -e "  ${YELLOW}If authentication fails, run: docker compose -f docker/compose.yml down -v && docker compose ... up -d${RESET}"
echo ""
